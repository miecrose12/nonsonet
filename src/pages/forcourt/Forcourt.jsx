...
/* ─── Floating stat card ─────────────────────────────────── */
const StatCard = () => (
  <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl max-w-[200px] border border-gray-100 z-10">
    <div className="flex items-center gap-2 mb-2">
      <span className="material-symbols-outlined text-emerald-700 text-xl">bolt</span>
      <span className="font-bold text-sm font-[Manrope]">Real-time Sync</span>
    </div>
...
const ArchCard = ({ icon, title, desc }) => (
  <div className="bg-[#f7f9fb] p-8 rounded-3xl border border-emerald-100/40">
    <span className="material-symbols-outlined text-emerald-700 mb-4 text-3xl block">{icon}</span>
    <h4 className="font-[Manrope] font-bold text-xl mb-3">{title}</h4>
...
const ChannelCard = ({ src, title, desc }) => (
  <div className="group relative overflow-hidden rounded-3xl aspect-[4/5]">
    ...
    <div className="absolute bottom-0 p-8">
      <h4 className="text-white font-[Manrope] text-2xl font-bold mb-2">{title}</h4>
  ...
  <div className="bg-white rounded-[2rem] overflow-hidden shadow-sm border border-gray-100">
    <div className="p-10">
      <div className="flex items-center gap-4 mb-8">
        <div className="w-12 h-12 bg-emerald-700 rounded-xl flex items-center justify-center text-white">
          <span className="material-symbols-outlined">{icon}</span>
        </div>
        <h3 className="font-[Manrope] text-3xl font-bold">{title}</h3>
      </div>
    ...
    <div className="bg-emerald-50 p-10 mt-4 h-64 relative">
      <img src={imgSrc} alt={title} className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
  </div>
);
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                ...
                <div className="hidden md:block">
                  <span className="text-emerald-700 font-[Manrope] font-bold text-sm tracking-widest uppercase">
                    The Nonsonet Edge
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  >
                    <div className="w-14 h-14 bg-emerald-100/50 rounded-2xl flex items-center justify-center mb-8">
                      <span className="material-symbols-outlined text-emerald-700 text-3xl">
                        {icon}
                      </span>
                    </div>
                    <h3 className="font-[Manrope] text-xl font-bold mb-4">{title}</h3>
          ...
          <section className="py-24 px-6 bg-white">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="font-[Manrope] text-3xl md:text-5xl font-extrabold mb-4 tracking-tight">
          ...
          <section className="py-24 px-6 bg-white">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20">
              <div className="lg:w-1/3">
                <span className="text-emerald-700 font-bold text-sm tracking-widest uppercase mb-4 block">
                  Engineered for Reliability
                </span>
                <h2 className="font-[Manrope] text-3xl md:text-4xl font-extrabold mb-8 tracking-tight">
